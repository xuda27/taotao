...
<body id="mainframe">
	...
	<form id="orderForm" class="hide" action="/order/create.html"
		...
		<input type="hidden" name="orderShipping.receiverName" value="徐达" />
		<input type="hidden" name="orderShipping.receiverMobile"
			value="1821037302" /> <input type="hidden"
			name="orderShipping.receiverState" value="湖南省" /> <input type="hidden"
			name="orderShipping.receiverCity" value="衡阳市" /> <input type="hidden"
			name="orderShipping.receiverDistrict" value="珠晖区" /> <input
									...
									<ul class="ui-switchable-panel-main" id="consignee-list">
										...
										<li class="ui-switchable-panel" id="consignee_index_137617472"
											...
											<div class="consignee-item item-selected"
												...
												<div class="user-name">
													<div class="fl">
														<strong limit="4">徐达</strong>&nbsp;&nbsp;收
													</div>
													<div class="fr">18216037302</div>
													<div class="clr"></div>
												</div>
												<div class="mt10" limit="15">湖南省衡阳市珠晖区衡花路16号</div>
												<div class="adr-m" limit="30">衡阳师范学院</div>
						...
						<div id="shipAndSkuInfo">
							<div id="payShipAndSkuInfo">
								...
								<div class="step-tit">
									<h3>送货清单</h3>
									<div class="extra-r">
										<a href="/cart/show.html" id="cartRetureUrl"
							...
							<div class="sticky-wrap">
								<div class="inner">
									...
									<div style="display: none" id="factoryShipCodShowDivBottom"
										class="dispatching">部分商品货到付款方式：先由淘淘配送“提货单”并收款，然后厂商发货。</div>
								</div>
